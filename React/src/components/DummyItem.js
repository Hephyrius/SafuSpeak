  ...
  render() {
    ...
    return (
      <div className="DummyItem">
        <div class="container">
            <div class="row">
              There are no {type}'s to display. Try refreshing the page to load events from the Binance Virtual Machine. If no events are shown, try pointing your tronlink to another event server as api.trongrid.io will only show events from the last ~6 hours.
            </div>
          </div>
        </div>
    );
